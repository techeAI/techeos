...
import { IconAnchor, IconLanguage, IconSchema, IconVersions, IconVocabulary } from '@tabler/icons-react';
...
import { Contributors } from '~/components/layout/header/About/Contributors';
